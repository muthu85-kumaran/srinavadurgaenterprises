...
import { listPumpTypeInsAction } from "@/actions/masters/PumpTypeInsAction";
import Link from "next/link";

const columns: ColumnDef<PumpTypeIns>[] = [
  {
    header: "Id",
    accessorKey: "id",
...

  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Link href={`/admin/masters/pumptypeins/${phase.id}`}>
...
const ListPumpTypeIns = () => {
  ...
  const [PumpTypeIns, setPumpTypeIns] = useState<PumpTypeIns[]>([]);
  ...
  useEffect(() => {
    setLoading(true);
    listPumpTypeInsAction().then((data) => {
...
export default ListPumpTypeIns;
