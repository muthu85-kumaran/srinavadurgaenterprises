...
import { listPumpTypeAppAction } from "@/actions/masters/PumpTypeAppAction";
import Link from "next/link";

const columns: ColumnDef<PumpTypeApp>[] = [
  {
    header: "Id",
    accessorKey: "id",
...

  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Link href={`/admin/masters/pumptypeapp/${phase.id}`}>
...
const ListPumpTypeApp = () => {
  ...
  const [pumpTypeApp, setPumpTypeApp] = useState<PumpTypeApp[]>([]);
  ...
  useEffect(() => {
    setLoading(true);
    listPumpTypeAppAction().then((data) => {
...
export default ListPumpTypeApp;
