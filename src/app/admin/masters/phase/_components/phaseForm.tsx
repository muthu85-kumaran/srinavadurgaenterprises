...
import { Phase, PhaseSchema } from "@/types/phase";
import { addPhaseAction } from "@/actions/masters/PhaseAddAction";
...
const PhaseForm = ({ phase }: PhaseFormProps) => {
  ...
  const formData = useForm<z.infer<typeof PhaseSchema>>({
        ...
        <form
          ...
          action={async (formData: FormData) => {
            ...
            if (result.errors.length > 0) {
              ...
              router.push("/admin/masters/phase");
            }
          }}
        >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter Phase" {...field} />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Describe about the phase with mininum 10 characters"
