...
function taxdisplay(sales: SalesInvoice) {
  var result = [];
  for (let index = 0; index < sales.invoiceItems.length; index++) {
    const currenttax =
      sales.invoiceItems[index].product.productTax?.taxInPercent;
    const currentamount = sales.invoiceItems[index].taxAmount;
...
const ViewInvoice = ({ sales }: ViewInvoiceProps) => {
        ...
        <div className="border">
            ...
            <div className="flex justify-between p-2">
              ...
              <div>
                <div className="text-sm">
                  <span className="font-semibold mr-3">Invoice #:</span>
                  {sales.invoiceNo}
                </div>
                <div className="text-sm">
                  <span className="font-semibold mr-3">Invoice Date:</span>
                  {getFormattedDate(sales.invoiceDate)}
                </div>
                <div className="text-sm">
                  <span className="font-semibold mr-3">Order #:</span>
                  {sales.salesOrder?.orderNo}
                </div>
                <div className="text-sm">
                  <span className="font-semibold mr-3">Date: </span>
                  {sales.salesOrder &&
                    getFormattedDate(sales.salesOrder.orderDate)}
                </div>
                <div className="text-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-end p-2">
                    {getFormattedCurrency(sales.invoiceGrossAmount)}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="text-end p-2 font-semibold">
                    {getFormattedCurrency(sales.invoiceTotalAmount)}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <p className="border-b p-2">
            ...
            <span className="font-semibold">
              {price_in_words(sales.invoiceTotalAmount)} only
            </span>
          </p>
