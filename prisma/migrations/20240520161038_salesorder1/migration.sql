/*
  ...
  - Added the required column `paymentModeId` to the `SalesOrder` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `salesorder` ADD COLUMN `paymentModeId` VARCHAR(191) NOT NULL;
