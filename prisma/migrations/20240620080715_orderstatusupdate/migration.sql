...
-- AlterTable
ALTER TABLE `purchaseinvoicestatus` MODIFY `statusCode` ENUM('PENDING', 'CONFIRMED', 'INVOICED', 'DISPATCHED', 'DELIVERED', 'RETURNED', 'PARTIALLY_RETURNED', 'CANCELLED') NOT NULL;

-- AlterTable
ALTER TABLE `purchaseorderstatus` MODIFY `statusCode` ENUM('PENDING', 'CONFIRMED', 'INVOICED', 'DISPATCHED', 'DELIVERED', 'RETURNED', 'PARTIALLY_RETURNED', 'CANCELLED') NOT NULL;

-- AlterTable
ALTER TABLE `salesorderstatus` MODIFY `statusCode` ENUM('PENDING', 'CONFIRMED', 'INVOICED', 'DISPATCHED', 'DELIVERED', 'RETURNED', 'PARTIALLY_RETURNED', 'CANCELLED') NOT NULL;
