/*
  ...
  - Added the required column `accountType` to the `VendorBankDetail` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `vendorbankdetail` ADD COLUMN `accountType` VARCHAR(191) NOT NULL;
