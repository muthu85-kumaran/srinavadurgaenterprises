/*
  ...
  - Added the required column `paymentModeId` to the `PurchaseInvoice` table without a default value. This is not possible if the table is not empty.
  - Added the required column `paymentModeId` to the `PurchaseOrder` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `payment` ADD COLUMN `purchaseOrderId` VARCHAR(191) NOT NULL;

-- AlterTable
ALTER TABLE `purchaseinvoice` ADD COLUMN `paymentModeId` VARCHAR(191) NOT NULL;

-- AlterTable
ALTER TABLE `purchaseorder` ADD COLUMN `paymentModeId` VARCHAR(191) NOT NULL;
