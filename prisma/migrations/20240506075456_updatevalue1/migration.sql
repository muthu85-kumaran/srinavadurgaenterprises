/*
  ...
  - You are about to alter the column `valueDeliverySize` on the `deliverysizeinmm` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
  - You are about to alter the column `valueInHP` on the `powerinhp` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Double`.
  - You are about to alter the column `valueInKW` on the `powerinkw` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Double`.
  - You are about to alter the column `valueInVolt` on the `ratedvoltageinvolt` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
  - You are about to alter the column `valueSuctionSize` on the `suctionsizeinmm` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
...
-- AlterTable
ALTER TABLE `deliverysizeinmm` MODIFY `valueDeliverySize` INTEGER NOT NULL;

-- AlterTable
ALTER TABLE `powerinhp` MODIFY `valueInHP` DOUBLE NOT NULL;

-- AlterTable
ALTER TABLE `powerinkw` MODIFY `valueInKW` DOUBLE NOT NULL;

-- AlterTable
ALTER TABLE `ratedvoltageinvolt` MODIFY `valueInVolt` INTEGER NOT NULL;

-- AlterTable
ALTER TABLE `suctionsizeinmm` MODIFY `valueSuctionSize` INTEGER NOT NULL;
