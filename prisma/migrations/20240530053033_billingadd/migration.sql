/*
  ...
  - Added the required column `contactNo` to the `BillingAddress` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `contactNo` to the `ShippingAddress` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `billingaddress` ADD COLUMN `contactNo` VARCHAR(191) NOT NULL,
    ADD COLUMN `name` VARCHAR(191) NOT NULL;

-- AlterTable
ALTER TABLE `shippingaddress` ADD COLUMN `contactNo` VARCHAR(191) NOT NULL,
    ADD COLUMN `name` VARCHAR(191) NOT NULL;
